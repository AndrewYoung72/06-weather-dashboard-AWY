    ...
    .then(function (data) {
      ...
      fetch(weatherUrl)
        ...
        .then(function (weatherData) {
          ...
          dateEl.textContent = moment(weatherData.daily[1].dt * 1000).format(
            "MMM D YYYY",
          );
          ...
          nDateEl.textContent = moment(weatherData.daily[2].dt * 1000).format(
            "MMM D YYYY",
          );
          nIconEl.src =
            "https://openweathermap.org/img/wn/" +
          ...
          sDateEl.textContent = moment(weatherData.daily[3].dt * 1000).format(
            "MMM D YYYY",
          );
          sIconEl.src =
            "https://openweathermap.org/img/wn/" +
          ...
          tDateEl.textContent = moment(weatherData.daily[4].dt * 1000).format(
            "MMM D YYYY",
          );
          tIconEl.src =
            "https://openweathermap.org/img/wn/" +
          ...
          fDateEl.textContent = moment(weatherData.daily[4].dt * 1000).format(
            "MMM D YYYY",
          );
          fIconEl.src =
            "https://openweathermap.org/img/wn/" +
